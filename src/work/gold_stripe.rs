...
use crate::tools::material::DiffuseLight;
...
use crate::tools::texture::GoldStripeTexture;
...
pub fn render() {
    let path = prepare_output_path("output/work/gold_stripe.png");

    // ============ 材质 ============

    // 金色条纹发光纹理
    let gold_tex = Arc::new(GoldStripeTexture::new(1.0));
    let gold_light = Arc::new(DiffuseLight::new_with_texture(gold_tex));
